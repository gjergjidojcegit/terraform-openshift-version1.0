...
sudo yum -y --enablerepo C7.3.1611-extras install docker-1.12.6*

sudo sed -i -e "s/.*OPTIONS=.*/OPTIONS='--selinux-enabled=false --insecure-registry 172.30.0.0\\/16'/g" /etc/sysconfig/docker
